...
CREATE TABLE "Conversations" (
    ...
    "inputTokenAmount" INTEGER NOT NULL,
    "outputTokenAmount" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Conversations" ADD CONSTRAINT "Conversations_apiKeyId_fkey" FOREIGN KEY ("apiKeyId") REFERENCES "ApiKey"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
